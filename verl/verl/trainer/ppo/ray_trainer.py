                ...
                with marked_timer("step", timing_raw):
                    ...
                    with marked_timer("reward", timing_raw, color="yellow"):
                        ...
                        if self.use_rm and "rm_scores" not in batch.batch.keys():
                            ...
                            tide_keep_neg = self.config.actor_rollout_ref.rollout.get("tide_keep_neg", 0.2)
                            tide_keep_pos = self.config.actor_rollout_ref.rollout.get("tide_keep_pos", 0.2)
                            tide_deficit_lambda = self.config.actor_rollout_ref.rollout.get("tide_deficit_lambda", 1.0)
                            ...
                            batch.meta_info["tide_keep_neg"] = tide_keep_neg
                            batch.meta_info["tide_keep_pos"] = tide_keep_pos
                            batch.meta_info["tide_deficit_lambda"] = tide_deficit_lambda
