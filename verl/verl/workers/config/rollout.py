...
class RolloutConfig(BaseConfig):
    ...
    # TIDE (top_k_strategy="tide"): quantile keep-rates rho^- / rho^+ of the
    # excess and deficit active sets, and the deficit-branch weight lambda.
    tide_keep_neg: float = 0.2
    tide_keep_pos: float = 0.2
    tide_deficit_lambda: float = 1.0
